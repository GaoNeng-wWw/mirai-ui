<template>
  <div class="flex flex-wrap items-center gap-3">
    ...
    <div>
      <label>
        <input type="radio" id="shape" v-model="shape" value="solid" />
        solid
      </label>
      <label>
        <input type="radio" id="shape" v-model="shape" value="outline" />
        outline
      </label>
      <label>
        <input type="radio" id="shape" v-model="shape" value="flat" />
        flat
      </label>
    </div>
    <div>
